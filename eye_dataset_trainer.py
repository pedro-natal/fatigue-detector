...
class EyeDatasetTrainer:
    ...
    def __init__(self):
        print("👁️ Iniciando Treinador de Dataset de Olhos")
        print("🎯 Este sistema treina APENAS com imagens de olhos!")
    ...
    def visualizar_resultados(self, resultados):
        ...
        plt.savefig(f'eye_training_results_{timestamp}.png', dpi=300, bbox_inches='tight')
...
def main():
    """Função principal"""
    print("👁️ TREINADOR DE DATASET DE OLHOS")
    print("=" * 50)
    ...
    while True:
        ...
        if opcao == '1':
            ...
            # Prepara dataset
            X, y, alerta_count, sono_count = trainer.preparar_dataset_olhos(dataset_path)
